...
{
	std::string banner = "Manybody OpenCL v2: N^2, cache unaware, aliased, minimal calculating";
	...
	try
	{
		...
		std::ifstream source_file(std::string(MANYBODY_OPENCL_KERNEL_PATH) + "manybody-cl-v2-single-device.cl");
