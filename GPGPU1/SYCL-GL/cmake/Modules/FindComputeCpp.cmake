...
function(__build_spir targetName sourceFile binaryDir fileCounter)
  ...
  foreach(directory ${targetIncludeDirectories})
    set(device_compiler_includes "-I${directory}" ${device_compiler_includes})
  endforeach()
  get_target_property(interfaceLinkLibraries ${targetName} INTERFACE_LINK_LIBRARIES)
  foreach(library ${interfaceLinkLibraries})
	get_target_property(interfaceIncludeDirectories ${library} INTERFACE_INCLUDE_DIRECTORIES)
	if(NOT(interfaceIncludeDirectories MATCHES "interfaceIncludeDirectories-NOTFOUND"))
	  foreach(directory ${interfaceIncludeDirectories})
        set(device_compiler_includes "-I${directory}" ${device_compiler_includes})
      endforeach()
	endif()
    set(device_compiler_includes "-I${directory}" ${device_compiler_includes})
